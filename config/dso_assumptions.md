...
- **Peak MW reduction:** `(reference_peak_MW − scenario_peak_MW) × rate` once per year (not ×365).
...
| `eur_per_peak_mw_reduction_year` | 6,000 | EUR per year for each **MW** lower daily peak load vs reference |
