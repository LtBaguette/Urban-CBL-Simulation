...
def load_residuals_config(
    ...
    hourly_repeats = int(res.get("simulation_repeats", 5))
    return sim_cfg, ResidualsConfig(
        app_adoption_rate=float(res.get("app_adoption_rate", 0.60)),
        simulation_repeats=hourly_repeats,
        v5_simulation_repeats=int(res.get("v5_simulation_repeats", hourly_repeats)),
